...
import LoanBill from '../components/watch/LoanBill'
...
class Loan extends Component {
	...
	listProject() {
		...
		getData(getRouter(getList("loanExpenditureManagement","Loan")), { token: sessionStorage.token }, cb, {});
// 
	}
